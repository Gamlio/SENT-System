            ...
            <table className="w-full text-left border-collapse whitespace-nowrap">
                <thead className="sticky top-0 z-10 bg-[#111827]">
                    <tr className="border-b border-slate-800 text-[10px] uppercase tracking-widest text-slate-500">
                        <th className="p-3 font-black">Nhân viên</th>
                        <th className="p-3 font-black">Liên hệ</th>
                        <th className="p-3 font-black">Máy trạm & Sự cố</th>
                        <th className="p-3 font-black">Chính sách & Tài liệu</th>
                        <th className="p-3 font-black">Quản trị Hệ thống</th>
                        {canManageUsers && <th className="p-3 text-right font-black">Thao tác</th>}
                    </tr>
                </thead>
                <tbody className="divide-y divide-slate-800/50">
                    {users.map((u) => (
                        <tr key={u.id} className="hover:bg-slate-800/30 transition-colors cursor-pointer group">
