...
description: "Dùng khi thêm loại dữ liệu thu thập mới từ Agent, đồng bộ qua Backend và chỉ hiển thị trong luồng xử lý Sự cố (Incidents)."
---
...
## 1. Tầng Thu thập (Agent & Payload)
* Phân tích cấu trúc dữ liệu mới từ phần mềm Agent.
...
* **PostgreSQL:** Không thay đổi bảng Agent chung; chỉ tạo liên kết qua `IncidentID` nếu dữ liệu này dùng làm bằng chứng sự cố.

## 3. Tầng Hiển thị (Targeted UI)
* **Quy tắc vàng:** Không hiển thị dữ liệu này ở trang thông tin Agent chung để tránh làm rối giao diện.
